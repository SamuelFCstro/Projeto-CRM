...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    webAppCRMDesignAuthUserSubject.add(
      WebAppCRMDesignAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<WebAppCRMDesignAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  WebAppCRMDesignAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = WebAppCRMDesignAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    webAppCRMDesignAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
WebAppCRMDesignAuthUser? currentUser;
